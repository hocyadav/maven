...
//1. skeleton
//2. add lock
public class MyOwnBlockingQueue_5HandleEdgeCase<E> {
	Queue<E> queue;
	...
	public MyOwnBlockingQueue_5HandleEdgeCase(int newSize) {
	...
	public E take() {
		...
		try {
			...
			}//when then both 2 thread get signal to execute then they come here..same time
