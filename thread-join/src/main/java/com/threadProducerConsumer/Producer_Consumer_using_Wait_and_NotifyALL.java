...
import com.threadProducerConsumer.MyBQImpl.MyOwnBlockingQueue_using_Lock_NotifyAll;
import com.threadProducerConsumer.MyBQImpl.MyOwnBlockingQueue_using_Lock_and_Condition;

public class Producer_Consumer_using_Wait_and_NotifyALL {
	...
	public static MyOwnBlockingQueue_using_Lock_NotifyAll<Integer> myOwnBlockingQueue =new MyOwnBlockingQueue_using_Lock_NotifyAll<Integer>(10);
